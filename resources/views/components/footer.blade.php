            ...
            <div class="py-4 mobile:text-lg" style="border-color: rgba(255,255,255, 0.5)">
                <div class="text-gray-300 text-base md:text-xs text-center">
                    <p class="mb-5 md:mb-2 tracking-normal">
                        © InformatikaPiksi 2020. All rights reserved. <br class="md:hidden" />
                        Stay productive, work & study spirit!
                    </p>
                    <p class="tracking-normal">
                        <span class="mobile:block">
                            ...
                            by
                            <a href="https://github.com/rizkyfirman15" class="font-bold inherits-color link hover:text-white">rizkyfirman15</a>.
                        </span>
                    </p>
                </div>
            </div>
