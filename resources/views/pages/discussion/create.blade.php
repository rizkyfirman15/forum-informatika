...
<form action="{{ route('discussion.store') }}" method="POST">
    ...
    <div class="flex w-full">
        <div class="block w-full px-6 lg:w-9/12 mx-auto mt-4 mb-10 justify-center" style="min-height: 80vh;">
            ...
            <!-- aw -->
            <div>
                <a href="{{ route('discussion.index') }}" class="inline-block text-center p-3 mt-4 bg-red-500 text-white rounded shadow hover:bg-red-600" style="min-width: 100px;">
            ...
            <div class="w-full mt-4 bg-white shadow-xl rounded">
                ...
                <input value="{{ old('title') }}" type="title" name="title" class="block w-full p-3 bg-gray-200 border-transparent focus:outline-none hover:bg-gray-300 focus:bg-gray-300" required placeholder="Title...">
            </div>
            
            <!-- tag -->
            <div class="w-full mt-4 bg-white shadow-xl rounded">
                <div class="p-2 pl-4 text-gray-600 font-bold bg-gray-100 border-b border-gray-200">
                    Berikan tag untuk memesan diskusi Anda ...
                </div>
            ...
            <div id="to-reply" class="block bg-indigo-300 p-3 text-center text-white mt-4">
                ...
                <a class="underline hover:text-blue-400" href="#">
            ...
            <div class="w-full mt-4 bg-white shadow-xl rounded">
                <div class="flex p-2 pl-4 text-gray-600 font-bold bg-gray-100 border-b border-2ray-400 content-center items-center justify-center">
                    <div class="w-6/12">Ketikkan Pertanyaan Anda ...</div>
...
<script>
    new Vue({
        ...
        mounted() {
            ...
            $('.select2').select2();
            $('.select2').val(@JSON(old('tags'))).trigger('change')
        }
    });
</script>
@endpush